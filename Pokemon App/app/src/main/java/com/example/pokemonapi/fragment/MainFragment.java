...
public class MainFragment extends Fragment implements PokemonRecyclerViewListAdapter.OnItemClickListener {
    ...
    //pull data and refresh the page
    ...
    //update ui data by fetched data
    ...
    //update toast if there is no connection because application need network to fetch data using api
